...
def apply_border(worksheet, rows, cols, border_style='thin'):
...
if __name__ == "__main__":
    ...
    filtered_xlsx_path, filtered_df = filter_columns(input_csv_file, output_xlsx_file, args.columns.split(","))
    ...
    if filtered_xlsx_path and filtered_df is not None:
        try:
            ...
            filtered_df.to_excel(filtered_xlsx_path, index=False, engine='openpyxl')
            ...
            apply_border(sheet, (1, sheet.max_row), (1, sheet.max_column), border_style='medium')
            ...
            # Apply thick outside borders to column headers and whole table
            apply_border(sheet, (1, 1), (1, sheet.max_column), border_style='thick')
            apply_border(sheet, (1, sheet.max_row), (1, sheet.max_column), border_style='thick')
